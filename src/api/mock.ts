...
function genRecords(count: number) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const source = ["zcode", "codex", "dsh", "workbuddy", "workbuddy-ai", "reasonix", "codebuddy", "qoder", "qoder-cn"][i % 9];
        ...
        switch (cmd) {
          case "load_config":
            resolve({
              ...
              sourceVisibility: {
                order: ["zcode", "codex", "dsh", "workbuddy", "workbuddy-ai", "reasonix", "codebuddy", "qoder", "qoder-cn"],
                hidden: [],
                initialized: true,
              },
