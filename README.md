...
│       ├── adapter-trae-solo.cjs # TRAE SOLO 适配器（读 %APPDATA%/TRAE SOLO）
...
| TRAE SOLO | `%APPDATA%/TRAE SOLO` | 同 Trae（解密同密钥） | 停用 |
